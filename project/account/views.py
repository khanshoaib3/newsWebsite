        ...
        if form.is_valid():
            ...
            if user is not None :
                ...
                return render(request,
                                'account/files/signup.html',
                                {'form':form,
                                'response':'There is no account available for this username','nav':'common/nav.html','commonCss':'account/files/commonCss.html','commonJs':'account/files/commonJs.html'}) 
