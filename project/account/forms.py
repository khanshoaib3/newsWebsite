...
class reAuthenticate(forms.Form):
    password = forms.CharField(widget=forms.PasswordInput(attrs={'class':'innerInput','id':'promptInput','onmouseover':'inputHover(this)','onmouseout':'inputHover(this)','onchange':'inputChange(this)'}),required=False,label="")
